    ...
    <div class="dashboard">
        ...
        <div class="content">
            <div class="mt-4"
                ...
                <label style="margin: 1.5rem 0 0 2rem; font-size: 21px; font-weight: 500;">Tags</label>
                <button><i class="bi bi-2-square"></i>Nouveau tag</button>
            </div>
            ...
            <div class="d-flex mt-4 justify-content-between py-3 px-4"
                ...
                <div class="card text-bg-dark text-center w-100">
                    <div class="card-header border-light bg-transparent">
                    ...
                    <div class="card-body">
                        ...
                        <a href="#" class="btn btn-primary">Add a new tag</a>
                    </div>
                    <div class="card-footer border-light text-body-secondary bg-transparent">
