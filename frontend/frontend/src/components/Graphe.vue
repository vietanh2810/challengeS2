                        ...
                        <Form @submit="createGraphe" :validation-schema="schema">
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <Field name="graphe_type" v-model="grapheData.graphe_type" type="text" class="form-control" />
    ...
    methods: {
        createGraphe() {
            ...
            const requestOptions = {
                ...
                body: JSON.stringify({ graphe_type: this.grapheData.graphe_type,
